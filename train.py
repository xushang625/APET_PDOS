...
def subprocess_fn(args):
    ...
    train_dataloader = builder.get_dataloader(split='train', smear=args.smear, dos_minmax = args.dos_minmax, dos_zscore=args.dos_zscore, scale_factor=args.scale_factor, apply_log=args.apply_log)
    logger.info('Train dataloaders build complete')
    test_dataloader = builder.get_dataloader(split='test', smear=args.smear, dos_minmax = args.dos_minmax, dos_zscore=args.dos_zscore, scale_factor=args.scale_factor, apply_log=args.apply_log)
    logger.info('Test dataloaders build complete')
    valid_dataloader = builder.get_dataloader(split='valid', smear=args.smear, dos_minmax = args.dos_minmax, dos_zscore=args.dos_zscore, scale_factor=args.scale_factor, apply_log=args.apply_log)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dos_minmax',  type = str2bool,    default = False,                                        help = 'standarlize')
    parser.add_argument('--dos_zscore',  type = str2bool,    default = False,                                        help = 'standarlize')
